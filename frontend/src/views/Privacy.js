...
const Privacy = () => {
  return (
    <div style={{margin:"10px",marginTop:"100px"}}>
      <h1 class="kb-title">Privacy Statement</h1>
      <div>
        <p>
          ...
          including your personal information in connection with the Synergyze
          service.
        </p>
        <h3>Contacting Us</h3>
        <p>
          ...
          at <a href="https://help.Synergyze.com">help.Synergyze.com</a>. For
          questions specifically about this Privacy Statement, or our use of
          ...
          <a href="mailto:privacy@Synergyze.com">privacy@Synergyze.com</a>.{" "}
        </p>
        <p>
          The data controller of your personal information is{" "}
          <a href="https://help.Synergyze.com/legal/corpinfo">
            Synergyze Entertainment Services India LLP
          </a>
        ...
        <ul>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  the &quot;Account&quot; section of our website), or otherwise
                  provide information to us through our service or elsewhere.
                </p>
              </li>
            </ul>
          </li>
          <li>
            <p>
              ...
              other Synergyze capable devices you might use to access our service
              (such as gaming systems, smart TVs, mobile devices, set top boxes,
              and other streaming media devices). This information includes:
            </p>
            <ul>
              <li>
                <p>
                  your activity on the Synergyze service, such as title
                  selections, shows you have watched, search queries, and
                  activity in Synergyze games;
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  network devices, and devices that are Synergyze capable on your
                  Wi-Fi network;
                </p>
              </li>
              <li>
                <p>
                  ...
                  &quot;Cookies and Internet Advertising&quot; section below for
                  more information);
                </p>
              </li>
              <li>
          ...
          <li>
            <p>
              <strong>Information from partners:</strong> We collect information
              from other companies with whom you have a relationship
              (“Partners”). These Partners might include (depending on what
              services you use): your TV or internet service provider, or other
              streaming media device providers who make our service available on
              their device; mobile phone carriers or other companies who provide
              services to you and collect payment for the Synergyze service for
              distribution to us or provide pre-paid promotions for the Synergyze
              service; and voice assistant platform providers who enable
              interaction with our service through voice commands. The
              information Partners provide us varies depending on the nature of
              the Partner services, and may include:{" "}
            </p>
            <ul>
              <li>
                <p>
                  search queries and commands applicable to Synergyze that you
              ...
              <li>
                <p>
                  ...
                  information, that support user authentication, the Synergyze
                  service registration experience, Partner payment processing,
                  and the presentation of Synergyze content to you through
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  security of Synergyze accounts;
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  functions within Synergyze games, such as multiplayer gameplay,
        ...
        <p>
          ...
          payments, and to communicate with you on these and other topics. For
        ...
        <ul>
          ...
          <li>
            <p>
              coordinate with Partners on making the Synergyze service available
              to members and providing information to non members about the
              availability of the Synergyze service, based on the specific
          ...
          <li>
            <p>
              ...
              determining whether and for which Synergyze signup offers you are
          ...
          <li>
            <p>
              ...
              you news about Synergyze, details about new features and content
              available on Synergyze, special offers, promotional announcements,
              consumer surveys, and to assist you with operational requests such
              as password reset requests. These communications may be by various
              ...
              of this Privacy Statement to learn how to set or change your
        ...
        <p>
          ...
          mood to watch when you log in. However, our recommendations system
          does not infer or attach socio-demographic information (like gender or
          race) to you. We have a Help article that explains how our
          recommendations system works - spoilers: the biggest driver of
          recommendations is what you actually choose to watch through our
          service. You can read the article at{" "}
          <a href="https://www.Synergyze.com/recommendations">
            www.Synergyze.com/recommendations
          </a>
          .
        </p>
        <p></p>
        ...
        <ul>
          <li>
            <p>
              <strong>The Synergyze family of companies:</strong> We share your
              information among the Synergyze family of companies (
              <a href="https://help.Synergyze.com/legal/corpinfo">
                help.Synergyze.com/legal/corpinfo
              </a>
          ...
          <li>
            <p>
              <strong>Service Providers:</strong> We use other companies, agents
              or contractors (&quot;Service Providers&quot;) to perform services
              ...
              methods, to provide bank account or balance information, to
              provide customer service, to analyze and enhance data (including
              data about users&#x27; interactions with our service), and to
              process and administer consumer surveys. In the course of
              providing such services, these Service Providers may have access
              to your personal or other information. We do not authorize them to
              use or disclose your personal information except in connection
          ...
          <li>
            <p>
              ...
              with them on providing the Synergyze service to members and
              providing information about the availability of the Synergyze
              service. For example, depending on what Partner services you use,
            ...
            <ul>
              <li>
                <p>
                  ...
                  collection of payment for the Synergyze service for distribution
                  to us;{" "}
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  so that content and features available in the Synergyze service
                  can be suggested to you in the Partner’s user interface. For
                  members, these suggestions are part of the Synergyze service and
          ...
          <li>
            <p>
              <strong>Promotional offers:</strong> We may offer joint promotions
              or programs that, in order for your participation, will require us
              to share your information with third parties. In fulfilling these
          ...
          <li>
            <p>
              <strong>Protection of Synergyze and others:</strong> Synergyze and its
              ...
              rights, property or safety of Synergyze, its users or the public, as
        ...
        <p>
          ...
          by the applicable laws on data protection.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              through Synergyze game features, such as multiplayer options and
              leaderboards.
            </p>
          </li>
        </ul>
        <p>
          ...
          policies. Similarly, some of the Synergyze game features mentioned above
        ...
        <ul>
          <li>
            <p>
              ...
              your account, you can use the &quot;Remember me on this
              device&quot; function when you log in to the website. This
              function uses technology that enables us to provide direct account
              access and to help administer the Synergyze service without
              requiring reentry of any password or other user identification
              when your browser revisits the service. 
            </p>
          </li>
          <li>
            <p>
              ...
              they will be able to see shows you have watched, ratings, account
              information (including your email address or other information in
              the &quot;Account&quot; area of our website), and game related
              information (such as your in-game name and saved game progress).
              This remains true even if you use our profiles feature. You might
              have the option to use seamless account login through the Synergyze
              mobile app, which enables login to the Synergyze app on smart TVs,
              set top boxes, and other streaming media devices on the Wi-Fi
              network to which you are connected. If you use that feature, those
              devices will remain signed into your account unless you later log
          ...
          <li>
            <p>
              ...
              distinct, personalized Synergyze experience, built around the movies
              and shows of interest to them, as well as separate watch
              histories. Please note that profiles are available to everyone who
              uses your Synergyze account, so that anyone with access to your
              Synergyze account can navigate to and use, edit or delete profiles.
              You should explain this to others with access to your account, and
              if you do not wish them to use or change your profile, be sure to
              let them know. Profile users may be offered the opportunity to add
              an email address, phone number or other information to the profile
              and will be provided with notice of collection and use at the time
              such information is requested (the Profile Privacy Notice applies
              (
              <a href="https://help.Synergyze.com/legal/profileprivacy">
                help.Synergyze.com/legal/profileprivacy
              </a>
              )). We have various parental controls available, you can learn
              more by reading our Help article located at{" "}
              <a href="https://help.Synergyze.com/node/264">
                https://help.Synergyze.com/node/264
              </a>
              .
            </p>
          </li>
          <li>
            <p>
              <strong>Removing device access to your Synergyze account:</strong>{" "}
              To remove access to your Synergyze account from your devices, visit
              the &quot;Account&quot; section of our website, choose &quot;Sign
              out of all devices,&quot; and follow the instructions to
              deactivate your devices (note, deactivation may not occur
              immediately). Where possible, users of public or shared devices
              should log out at the completion of each visit. If you sell or
              return a computer or Synergyze ready device, you should log out and
              deactivate the device before doing so. If you do not maintain the
              security of your password or device, or fail to log out or
        ...
        <p>
          ...
          receive certain communications from us via email or text message,
          simply access the &quot;Communications Settings&quot; option in the
          &quot;Account&quot; section of our website and uncheck those items to
          unsubscribe. Alternatively, click the &quot;unsubscribe&quot; link in
          the email or reply STOP (or as otherwise instructed) to the text
          message. Please note that you cannot unsubscribe from service-related
        ...
        <p>
          ...
          push notifications from Synergyze. On some device operating systems, you
          will be automatically enrolled in the notifications. If you
          subsequently decide you no longer wish to receive these notifications,
          you can use your mobile device&#x27;s settings functionality to turn
          them off. We also offer push notifications on certain web browsers. If
          you agree to receive those notifications and subsequently decide you
          no longer wish to receive these notifications, you can use your
          browser’s settings to turn them off.{" "}
        </p>
        <p>
          <strong>WhatsApp.</strong> If you have enabled WhatsApp messages in
          connection with your Synergyze account or profile and no longer wish to
          receive them, you can use your WhatsApp app settings to block them.
        </p>
        <p>
          <strong>Interest-Based Ads.</strong> Interest-based ads are online ads
          ...
          a mobile device, tablet, or streaming media device that includes a
          resettable device identifier, then that identifier can be used to help
          determine your likely interests. For your choices about interest-based
          ads from Synergyze, please see the &quot;Cookies and Internet
          Advertising&quot; section (below).
        </p>
        <p>
          <strong>Matched Identifier Communications.</strong> Some third party
          sites and apps allow us to reach our users with online promotions
          about our titles and services by sending a privacy protective
          identifier to the third party. A privacy protective identifier means
          we convert the original information (such as an email address or phone
          number) into a value to keep the original information from being
          revealed. The third party compares the privacy protective identifier
          to identifiers in its database and there will be a match only if you
          have used the same identifier (such as an email address) with Synergyze
          and the third party. If there is a match, Synergyze can then choose
          whether or not to send a given promotional communication to you on
          that third party site or app, and can optimize and better measure the
          effectiveness of online advertising. You can opt out in the “Marketing
        ...
        <p>
          ...
          you. You may also request that we delete personal information that we
          hold about you.
        </p>
        <p>
          When you visit the &quot;Account&quot; portion of our website, where
          you have the ability to access and update a broad range of information
          about your account, including your contact information, your Synergyze
          payment information, and various related information about your
          account (such as the content you have viewed and rated). You must be
          signed in to access the &quot;Account&quot; section.{" "}
        </p>
        <p>
          If you are the account owner, to download a copy of your personal
          information go to:{" "}
          <a target="_blank" href="https://www.Synergyze.com/account/getmyinfo">
            www.Synergyze.com/account/getmyinfo
          </a>{" "}
          (you must be signed in to access the &quot;Account&quot; section), and
          follow the instructions.{" "}
        </p>
        <p>
          For other requests, or if you have a question regarding our privacy
          practices, please contact our Data Protection Officer/Privacy Office
          at <a href="mailto:privacy@Synergyze.com">privacy@Synergyze.com</a>. For
          more information about how to access your information, including our
          verification process, please reference this help article: {" "}
          <a href="https://help.Synergyze.com/en/node/100624">
            help.Synergyze.com/node/100624
          </a>
          . For information about deletion, removal and retention of
          information, please reference this help article:{" "}
          <a href="https://help.Synergyze.com/en/node/100625">
            help.Synergyze.com/node/100625
          </a>
          ...
          data protection laws. Please also see the &quot;Your Choices&quot;
          section of this Privacy Statement for additional choices regarding
          your information.
        </p>
        <p>
          ...
          risks such as free trial fraud. We may retain information as required
          or permitted by applicable laws and regulations, including to honor
          your choices, for our billing or records purposes and to fulfill the
          purposes described in this Privacy Statement. We take reasonable
        ...
        <p>
          The Synergyze service may be provided through and/or utilize features
          ...
          able to access the Synergyze service through platforms such as gaming
          systems, smart TVs, mobile devices, set top boxes and a number of
          other Internet connected devices. These websites and platforms have
          separate and independent privacy or data policies, privacy statements,
          notices and terms of use, which we recommend you read carefully. In
          addition, you may encounter third party applications that interact
          with the Synergyze service.
        </p>
        <h3>Children</h3>
        <p>
          You must be at least 18 years of age or older to subscribe to the
          Synergyze service. Minors may only use the service with the involvement,
        ...
        <p>
          ...
          effect) in accordance with law. Your continued use of the Synergyze
          ...
          Statement, you may cancel your use of the Synergyze service. To see when
        ...
        <p>
          ...
          as web beacons), as well as resettable device identifiers, for various
          reasons. We want you to be informed about our use of these
        ...
        <p>
          ...
          store small amounts of data on your device. Web beacons (also known as
        ...
        <p>
          If you use the Synergyze app on a mobile device, tablet, or streaming
          ...
          devices and tablets (for example, the &quot;Identifier for
          Advertisers&quot; (or IDFA) on Apple iOS devices and the &quot;Google
          Advertising ID&quot; on Android devices), and certain streaming media
          devices. Like cookies, resettable device identifiers are used to make
          online advertising more relevant and for analytics and optimization
          purposes.   
        </p>
        <p>
          <strong>Why does Synergyze use these technologies?</strong>
        </p>
        <p>
        ...
        <ul>
          <li>
            <p>
              ...
              we and our Service Providers may use these cookies to authenticate
              and identify our members when they use our websites and
              applications so we can provide our service to them. They also help
              us to enforce our Terms of Use, prevent fraud and maintain the
          ...
          <li>
            <p>
              ...
              with Synergyze. For example, they help us to remember your
              ...
              pages, conversion rates, viewing patterns, click-through and other
              information) about our visitors&#x27; use of the Synergyze service
              so that we can enhance and personalize our website and service and
          ...
          <li>
            <p>
              ...
              about your use of this and other websites and apps, your response
              to ads and emails, and to deliver ads that are more relevant to
              you and for analytics and optimization purposes. These types of
              ads are called &quot;interest-based advertising.&quot; The
              advertising cookies associated with our service belong to our
              Service Providers. 
            </p>
          </li>
        </ul>
        <p>
          In connection with our use of these technologies, some of the websites
          and apps where we advertise, as well as advertising technology
          companies that we use to purchase, deliver, optimize, and/or measure
          our advertisements (collectively “Advertising Partners”), may receive
          limited information from us as part of our campaign targeting,
          measurement, and optimization (e.g., steps completed in sign-up and
          site visit or app open/install information).
        </p>
        <p>
          Common uses of this type of information are to judge the effectiveness
          of and optimize ad campaigns, by allowing Advertising Partners to see
          when someone who saw an ad later signed up for our service.  Another
          common use is to make sure we do not serve ads trying to get
          individuals to sign up for the Synergyze service if they are already a
          Synergyze user.  
        </p>
        <p>
          Synergyze uses contractual and technical measures designed to prevent
          Advertising Partners from accessing information regarding specific
          title selections you make, URLs you land on, or shows you have watched
          on our service. We do not share information about title selections or
          your shows you have watched on our service.  
        </p>
        <p>
          <strong>
        ...
        <p>
          <span id="cookie-preferences">
            <strong>To exercise choice regarding cookies</strong>
          </span>
        </p>
        <p>
          For more information about cookies set through our website, as well as
          other types of online tracking (including the collection of
          information by third parties about your online activities over time
          and across third-party websites or online services for online interest
          based advertising), and to exercise choices regarding them,{" "}
          <a href="#cookie-preferences">click here</a>. At this time, we do not
        ...
        <p>
          To opt out of interest-based ads from Synergyze in connection with a
          resettable device identifier on a mobile device, tablet, or streaming
          media devices, please configure the appropriate setting on your device
          (usually found under &quot;privacy&quot; or &quot;ads&quot; in your
          device&#x27;s settings). You may still see Synergyze ads on your device,
          but they will not be tailored to your likely interests. 
        </p>
        <p>
          <strong>To exercise choice regarding other technologies</strong>
        </p>
        <p>
          There are a number of ways to exercise choice regarding technologies
          that are similar to cookies, such as browser storage and plugins
          (e.g., HTML5, IndexedDB, and WebSQL). For example, many popular
          browsers provide the ability to clear browser storage, commonly in the
          settings or preferences area; see your browser&#x27;s help function or
          support area to learn more. Other technologies, such as Silverlight
          storage, may be cleared from within the application.{" "}
        </p>
        <p>
          To see the prior version of this document, please go to{" "}
          <a href="https://www.Synergyze.com/privacyupdates">
            www.Synergyze.com/privacyupdates
          </a>
          .
        </p>
        <p></p>
